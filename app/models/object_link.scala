...
final class ObjectLink private (val containerId : Container.Id, val objId : Object.Id, title_ : String, description_ : Option[String]) extends TableRow {
...
object ObjectLink extends TableView[ObjectLink]("object_link") {
  ...
  private[models] def get(c : Container.Id, o : Object.Id)(implicit db : Site.DB) : Option[ObjectLink] =
